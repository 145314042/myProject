...
public class Mahasiswa implements Comparable{
    ...
    public Mahasiswa(String nim, String nama, String nomorHp, String periode, String tanggal, String kelengkapan, String totalPeriode) {
        this.nim = nim;
        this.nama = nama;
    ...
    public int compareTo(Object o) {
        return (this.getTanggal()).compareTo(((Mahasiswa)o).getTanggal());
    }

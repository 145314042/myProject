 ...
 * @author Lycorice
 */
public class MahasiswaByNim implements Comparable{
    private String nim;
    private String nama;
    ...
    public MahasiswaByNim(String nim, String nama, String nomorHp, String periode, String tanggal, String kelengkapan, String totalPeriode) {
        this.nim = nim;
        this.nama = nama;
    ...
    public int compareTo(Object o) {
        return (this.getNim()).compareTo(((MahasiswaByNim)o).getNim());
    }

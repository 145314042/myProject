 ...
 * @author Kirizu
 */
public class Dua {//nama kelas yaitu Dua
    public static void main(String[] args) {//method yang digunakan
        ...
        int[] cadangan;//array cadangan dengan tipe integer
        ...
        cadangan=hitung;//nilai cadangan sama dengan hitung
        for(int i=0; i <= 4; i++) //nilai i adalah 0 dan bertipe integer, mengulang hingga i>4, nilai i bertambah 1
        ...
        for(int i=0; i <= 4; i++) //nilai i adalah 0 dan bertipe integer, mengulang hingga i>4, nilai i bertambah 1
            System.out.println("Data cadangan ke "+ (i+1) +" adalah "+cadangan[i]);//mencetak "Data cadangan ke "+memanggil 
                                                                            //nilai (i+1)+" : "+memanggil hitung[i]

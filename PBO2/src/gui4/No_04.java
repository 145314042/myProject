 ...
 * @author Lycorice
 */
public class No_04 extends JFrame {
        ...
        buttonok.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "'" + fieldinput.getText() +
            ...
            private void setAge(int age) throws Exception {
                ...
                else throw new NegativeValueException("Input must be greater than 0");
            }
        });

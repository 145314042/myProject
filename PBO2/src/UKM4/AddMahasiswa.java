    ...
    public AddMahasiswa(){
        ...
        buttonSave.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try{
                    File outFile = new File("DataPenduduk.data");
                    ...
                    String itemSplit=mhs.getClass().getName();
                    String[] split=itemSplit.split("[.]");
                    String text = mhs.getNim()+";"+mhs.getNama()+";"+mhs.getTempatTanggalLahir()+";"+split+";";
                    int confirmation = JOptionPane.showConfirmDialog(null, "NIM : "+mhs.getNim()+"\nNama : "+mhs.getNama()+
                            "\nTempat, tanggal lahir : "+mhs.getTempatTanggalLahir()+
                            "\nJenis anggota : "+split[1], "Save", JOptionPane.YES_NO_OPTION);
